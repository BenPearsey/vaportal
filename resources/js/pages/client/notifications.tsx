...
const breadcrumbs: BreadcrumbItem[] = [
  ...
  { title: 'Notifications', href: '/client/notifications' },
];

export default function ClientNotifications({ notifications }: Props) {
  return (
                    ...
                    <TableCell>
                      <a
                        ...
                        onClick={() =>
                          router.visit(
                            n.data.url ??
                              route('client.notifications.show', { notification: n.id })
                          )
                        }
                      >
