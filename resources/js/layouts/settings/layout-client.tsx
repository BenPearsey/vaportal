...
const tabs = [
  { title: 'Profile',   url: '/client/settings/profile'   },
  { title: 'Password',  url: '/client/settings/password'  },
  { title: 'Appearance',url: '/client/settings/appearance'},
];
...
export default function ClientSettingsLayout({ children }:{children:React.ReactNode}) {
  ...
  return (
    <div className="px-4 py-6">
      <Heading title="client settings" description="Manage your client account" />
